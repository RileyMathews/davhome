...
cAbbrevMonths = ["", "J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"]
...
def getDay(day, strl):
    return {
        LONG: cLongDays[day],
        SHORT: cShortDays[day],
        ABBREVIATED: cAbbrevDays[day],
    }[strl]
...
def getMonth(month, strl):
    return {
        LONG: cLongMonths[month],
        SHORT: cShortMonths[month],
        ABBREVIATED: cAbbrevMonths[month],
    }[strl]
